...
from ragaai_catalyst import RagaAICatalyst, Tracer, init_tracing, trace_agent, current_span
import uvicorn
...
def initialize_tracing():
    ...
    tracer = Tracer(
        project_name="ReAct_Agent_Example_FastAPI_test_version",
        dataset_name="react_agent_fastapi",
        tracer_type="Agentic",
    )
...
async def run_agent(payload: dict, background_tasks: BackgroundTasks):
    ...
    background_tasks.add_task(main, input)
