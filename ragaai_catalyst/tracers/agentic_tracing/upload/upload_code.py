...
def _fetch_dataset_code_hashes(project_name, dataset_name, base_url=None, timeout=120):
    ...
    try:
        ...
        session_manager._handle_request_exceptions(e, "fetching dataset code hashes")
        return None
...
def _fetch_presigned_url(project_name, dataset_name, base_url=None, timeout=120):
    ...
    try:
        ...
        session_manager._handle_request_exceptions(e, "fetching presigned URL")
        return None
    except RequestException as e:
        logger.error(f"Failed to list datasets: {e}")
        return None
...
def _put_zip_presigned_url(project_name, presignedUrl, filename, timeout=120):
    ...
    try:
        ...
        session_manager._handle_request_exceptions(e, "uploading zip to presigned URL")
        return False
    except RequestException as e:
...
def _insert_code(
    ...
    try:
        ...
        session_manager._handle_request_exceptions(e, "inserting code")
        return None
    except RequestException as e:
