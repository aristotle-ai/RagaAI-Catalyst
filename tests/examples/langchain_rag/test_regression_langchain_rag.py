...
def test_context_value():
    ...
    expected_context = "2. Transparency: Understanding how AI systems make decisions remains a challenge.\n3. General AI: Developing AI systems that can perform any intellectual task, not just specific ones, is\nstill a far-off goal."
