...
def setup_traces():
    ...
    if not os.path.exists(trace_file_path):
        print("Trace file does not exist, running research_assistant.py to generate it")
        success = run_diagnosis_agent()
        
        # Check again if trace file exists after attempting to run research_assistant.py
        if not os.path.exists(trace_file_path):
